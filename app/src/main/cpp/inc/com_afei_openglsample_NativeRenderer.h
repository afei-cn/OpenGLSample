...
#include <jni.h>
/* Header for class com_afei_openglsample_NativeRenderer */

#ifndef _Included_com_afei_openglsample_NativeRenderer
#define _Included_com_afei_openglsample_NativeRenderer
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_afei_openglsample_NativeRenderer
 * Method:    glInit
 * Signature: ()V
 */
